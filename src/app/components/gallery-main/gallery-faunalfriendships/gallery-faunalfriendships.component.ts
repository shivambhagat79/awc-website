...
@Component({
  ...
  templateUrl: './gallery-faunalfriendships.component.html',
  styleUrls: ['./gallery-faunalfriendships.component.css'],
})
export class GalleryFaunalfriendshipsComponent {
  ...
  mainArray: string[] = this.faunalfriendships;
