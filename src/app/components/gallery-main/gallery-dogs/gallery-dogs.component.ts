...
@Component({
  ...
  templateUrl: './gallery-dogs.component.html',
  styleUrls: ['./gallery-dogs.component.css'],
})
export class GalleryDogsComponent {
  ...
  mainArray: string[] = this.dogs.concat(this.faunalfriendships);
